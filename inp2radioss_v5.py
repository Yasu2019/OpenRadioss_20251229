...
def write_starter_file(output_path, nodes, elements, elset_elements):
    ...
    with open(output_path, 'w') as f:
        ...
        f.write("                  kg                   m                   s\n")
        f.write("                  kg                   m                   s\n")
        f.write("/TITLE\nPunch Die Shearing - SKINS V16 (Slave Node Group + N=5)\n")
        f.write("/NODE\n")
