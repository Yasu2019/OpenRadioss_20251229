...
### 3.4 Sol2SPH (v7) - 金属剪断加工には不適合 ⚠️
**症状:** 
- 時間ステップが急激に縮小 (5.8E-9 → 1.4E-10)
- エラー率が -20.3% に上昇
- 計算時間が ~7時間 → ~25時間以上に増加
- 材料が大きく歪み、不安定な挙動
...
**原因:**
- Sol2SPH は柔らかい材料（鳥、水、ゲル）に適している
- 金属の剪断加工では、固体要素 (FEM) の方が精度が高い
- SPH 粒子の接触処理が複雑化し、時間ステップが縮小

**教訓:**
- Sol2SPH は金属加工シミュレーションには不向き
- 要素削除 (Xmax) の方がシンプルで安定
- SPH が有効な用途: バードストライク、爆発、流体飛散

**推奨:** v5 または v6 (FEM + 要素削除) を使用
